            ...
            for r in `seq 1 1 10`; do
                for b in `seq 1 1 10`; do
                    ...
                    python main.py --algo $algo --output $folder/${directory//.}/ -a $a -e $e -r $r -b $b -l $l -r $reset
                                    --mazes maze_set3/unbias maze_set3/unbias maze_set3/antibiasR \
                                    maze_set3/antibiasR maze_set3/antibiasR maze_set3/unbias maze_set3/unbias \
                                    --trials 64 70 39 97 91 113 147
                done
            done
        done
    done
